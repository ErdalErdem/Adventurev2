                  ...
                  /*  case "attack" -> {
                        if (command.length() > 1) {
                            ...
                            switch (message) {
                                ...
                                case NO_ENEMY_FOUND_BY_THAT_NAME -> System.out.println("No enemy like " + (userChoise) + " in the room");
                                ...
                                case PLAYER_ATTACKED -> {
                                    ...
                                    System.out.println(userChoise) + " health: " + adventure.getCurrentEnemyHealth());
                                }
                                case PLAYER_DIED -> {
                                    System.out.println("GAME OVER\nYou were killed by the " + (userInput));
                                    System.exit(0);
                                }
                            }
                        } else {
